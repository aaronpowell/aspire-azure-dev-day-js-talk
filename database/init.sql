...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1000)
BEGIN
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1001)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1002)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1003)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1004)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1005)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1006)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 1 AND book_id = 1007)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 2 AND book_id = 1008)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 2 AND book_id = 1009)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 2 AND book_id = 1010)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 2 AND book_id = 1011)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 3 AND book_id = 1012)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 3 AND book_id = 1013)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 3 AND book_id = 1014)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 3 AND book_id = 1015)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 4 AND book_id = 1016)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 4 AND book_id = 1017)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 4 AND book_id = 1018)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 4 AND book_id = 1019)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 5 AND book_id = 1020)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 5 AND book_id = 1021)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 5 AND book_id = 1022)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
...
IF NOT EXISTS (SELECT 1
FROM dbo.books_authors
WHERE author_id = 5 AND book_id = 1023)
BEGIN
    INSERT INTO dbo.books_authors
        (author_id, book_id)
    VALUES
